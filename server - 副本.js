...
// const mysql = require('mysql2'); //放入db.js
const cors = require('cors');
// const bcrypt = require('bcryptjs'); //引入密钥库
// const jwt = require('jsonwebtoken'); // 引入 JWT 库 //转入auth.js
...
// const SECRET_KEY = 'my_super_secret_key_123'; //放入config.js
